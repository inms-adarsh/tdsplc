(function () {
    ...
    angular
        ...
        .factory('adminpaymentledgerService', adminpaymentledgerService);

    /** @ngInject */
    function adminpaymentledgerService($rootScope, $firebaseArray, $mdDialog, $mdToast, $firebaseObject, $compile, $q, adminService, authService, auth, firebaseUtils, dxUtils, config, msUtils, $firebaseStorage) {
